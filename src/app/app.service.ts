...
export class AppService {
  ...
  public constructor(
    ...
    this.updateError = {
      "/printer must have required property 'defaultFeedRate'": config => (config.printer.defaultFeedRate = 100),
      "/printer must have required property 'defaultFlowRate'": config => (config.printer.defaultFlowRate = 100),
  ...
  private checkUpdate(): void {
    this.http.get('https://api.github.com/repos/Stella3Dprint/StellaDash/releases/latest').subscribe({
