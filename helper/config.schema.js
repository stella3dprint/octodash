const configSchema = {
  ...
  properties: {
    ...
    printer: {
      ...
      type: 'object',
      required: ['name', 'xySpeed', 'zSpeed', 'disableExtruderGCode', 'zBabystepGCode', 'defaultFeedRate', 'defaultFlowRate', 'defaultTemperatureFanSpeed'],
      properties: {
        name: {
        ...
        defaultFeedRate: {
          $id: '#/properties/printer/properties/defaultFeedRate',
          type: 'integer',
        },
        defaultFlowRate: {
          $id: '#/properties/printer/properties/defaultFlowRate',
          type: 'integer',
        },
